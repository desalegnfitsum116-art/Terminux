...
use terminux_term::config::BidiMode;
...
impl terminux_term::TerminalConfiguration for TermConfig {
    ...
    fn canonicalize_pasted_newlines(&self) -> terminux_term::config::NewlineCanon {
        match self.configuration().canonicalize_pasted_newlines {
            None => terminux_term::config::NewlineCanon::default(),
            Some(NewlineCanon::None) => terminux_term::config::NewlineCanon::None,
            Some(NewlineCanon::LineFeed) => terminux_term::config::NewlineCanon::LineFeed,
            Some(NewlineCanon::CarriageReturn) => {
                terminux_term::config::NewlineCanon::CarriageReturn
            }
            Some(NewlineCanon::CarriageReturnAndLineFeed) => {
                terminux_term::config::NewlineCanon::CarriageReturnAndLineFeed
            }
        }
    }
