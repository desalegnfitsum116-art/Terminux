...
BEGIN
    ...
    BEGIN
        ...
        BEGIN
            ...
            VALUE "FileDescription",  "Terminux - Terminux - GPU Accelerated Terminal Emulator\0"
            VALUE "FileVersion",      "{version}\0"
            VALUE "LegalCopyright",   "Wez Furlong, MIT licensed\0"
            VALUE "InternalName",     "\0"
            VALUE "OriginalFilename", "\0"
            VALUE "ProductName",      "Terminux\0"
...
"#,
    ...
    #[cfg(target_os = "macos")]
    {
        ...
        println!("cargo:rerun-if-changed=assets/macos/Terminux.app/Contents/Info.plist");
