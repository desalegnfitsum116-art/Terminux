...
impl<'a> Performer<'a> {
    ...
    fn csi_dispatch(&mut self, csi: CSI) {
        ...
        match csi {
            ...
            CSI::Cursor(terminux_escape_parser::csi::Cursor::Left(n)) => {
    ...
    fn osc_dispatch(&mut self, osc: OperatingSystemCommand) {
        ...
        match osc {
            ...
            OperatingSystemCommand::ChangeDynamicColors(first_color, colors) => {
                ...
                use terminux_escape_parser::osc::DynamicColorNumber;
            ...
            OperatingSystemCommand::ConEmuProgress(prog) => {
                use terminux_escape_parser::osc::Progress as TProg;
                let prog = match prog {
