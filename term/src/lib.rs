...
use terminux_surface::SequenceNo;
...
pub use terminux_cell::*;
pub use terminux_surface::line::*;
...
pub struct CursorPosition {
    ...
    pub shape: terminux_surface::CursorShape,
    pub visibility: terminux_surface::CursorVisibility,
